...
<ul class="addrul">
    ...
    <li><span>详细地址 </span><input type = "text" name="detail" id="detailed" value="<?php echo $data1['province']?><?php echo $data1['city']?><?php echo $data1['town']?><?php echo $data1['detail']?>"></li>
