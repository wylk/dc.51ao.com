...
.shopPrice span{color:#ff6600;}
  ...
  .jd_win_box{width: 80%;padding: 5% 5%;border-radius: 4px;position: absolute;top:50%;left:50%;transform:translate(-50%, -50%);-webkit-transform:translate(-50%, -50%);}
...
<div class="jd_win">
  <div class="jd_win_box cancle" id="qr-code-autopay">
                ...
                alert(re.msg);
                   ...
                   WeixinJSBridge.invoke("getBrandWCPayRequest",re,function(res){
                                ...
                                if(res.err_msg=="get_brand_wcpay_request:ok"){
                                    ...
                                    setTimeout("window.location.href = '?m=plugin&p=wap&cn=index&id=food:sit:myindex'",2);
