...
<!-- 第一个菜单 -->
        <div class="right-con" style="width: 100%;">
            <ul>
                <li>
                ...
                <li>
                    <div class="menu-img"><img src="img/2.png" width="55" height="55" /></div>
                    <div class="menu-txt">
                        <h4>京酱肉丝</h4>
                        <p class="list1">家常菜</p>
                        <p class="list2">
                ...
                <li>
                    <div class="menu-img"><img src="img/7.jpg" width="55" height="55" /></div>
                    <div class="menu-txt">
                        <h4>京酱肉丝</h4>
                        <p class="list1">家常菜</p>
                        <p class="list2">
                ...
                <li>
                    <div class="menu-img"><img src="img/6.jpg" width="55" height="55" /></div>
                    <div class="menu-txt">
                        <h4>京酱肉丝</h4>
                        <p class="list1">家常菜</p>
                        <p class="list2">
                ...
                <li>
                    <div class="menu-img"><img src="img/8.jpg" width="55" height="55" /></div>
                    <div class="menu-txt">
                        <h4>京酱肉丝</h4>
                        <p class="list1">家常菜</p>
                        <p class="list2">
                ...
                <li>
                    <div class="menu-img"><img src="img/5.jpg" width="55" height="55" /></div>
                    <div class="menu-txt">
                        <h4>京酱肉丝</h4>
                        <p class="list1">家常菜</p>
                        <p class="list2">
