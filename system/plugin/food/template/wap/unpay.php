...
<style type="text/css">
    ...
    .billnum span.bright, .sumprice span.bright{float: right;}
    ...
    .bill_list .sumprice .bright{border-radius: 4px; width: 60px; text-align: center; height: 30px;margin-top:3px; line-height: 30px; background: #FF6600; }
    .bill_list .sumprice .bright a{color:#FFF;}
...
?>
    <li>
        <div class="billnum"><?php echo $v['shop_name']?><span class="bright"><a href="#">取消</a></span></div>
        ...
        <?php }}}?>
        <div class="sumprice">总价：￥<?php echo $v['total']?><span class="bright"><a href="#"><b>付款</b></a></span></div>
    </li>
<?php endforeach;}else{?>
暂无数据
<?php };?>
